...
const preferencesSchema = new mongoose.Schema({
  ...
  objectifs_de_carrière: String, //"Changer de carrière vers l'informatique", "Obtenir une promotion",
  Domaine_dinteret: String, //"Informatique", "Langues", "Finance"
  competences_acquises: String, //"communication", "Langues", "Finance","Programmation Java", "Conception graphique
  ...
  universite: String, //"esprit", "isam", "enci"
  ...
  duree_preferee: String, //des formations courtes et concises ou des cours plus longs et approfondis
  ...
  intérêts_specifiques : String, // indiquer des intérêts spécifiques ou des sous-domaines
